...
pub struct Config {
    ...
    pub mars_lp_pool: Addr,
    ///  MARS-UST LP Token address
    pub lp_token_address: Addr,
    ///  MARS-UST LP Tokens staking contract address
    pub lp_staking_contract: Addr,
    /// MARS token rewards to be used to incentivize boostrap auction participants
    pub mars_rewards: Uint256, 
    /// Timestamp from which MARS / UST can be deposited in the boostrap auction contract 
