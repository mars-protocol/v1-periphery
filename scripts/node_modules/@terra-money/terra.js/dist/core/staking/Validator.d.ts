...
export declare class Validator extends JSONSerializable<Validator.Data> {
     ...
     */
    constructor(operator_address: ValAddress, consensus_pubkey: ValConsPubKey.Data, jailed: boolean, status: number, tokens: Int, delegator_shares: Dec, description: Validator.Description, unbonding_height: number, unbonding_time: Date, commission: Validator.Commission, min_self_delegation: Int);
...
export declare namespace Validator {
    ...
    class Description extends JSONSerializable<Description.Data> {
        moniker: string;
        identity: string;
        website: string;
        details: string;
