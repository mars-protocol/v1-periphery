...
export declare class MsgCreateValidator extends JSONSerializable<MsgCreateValidator.Data> {
     ...
     */
    constructor(description: Validator.Description, commission: Validator.CommissionRates, min_self_delegation: Int, delegator_address: AccAddress, validator_address: ValAddress, pubkey: ValConsPubKey.Data, value: Coin);
